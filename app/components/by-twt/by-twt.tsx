    ...
    <View style={[predefinedStyle, style]}>
      <Svg height={height || 15} width={width || 20} viewBox="0 0 152 109">
        <G fill={fill}>
          ...
          <Path d="M144.57,47.82a30.77,30.77,0,0,0-4.83-15,32.54,32.54,0,0,0-13-12.12,33.33,33.33,0,0,0-20.51-3.33c-2.31.35-4.55,1.25-6.86,1.8-.59.12-1.53.12-1.84-.23A48,48,0,0,0,78,6c-.27-.12-.55-.28-1.09-.55a9.42,9.42,0,0,1,1.41-1.06,30.3,30.3,0,0,1,39.75,7.49c1.06,1.41,1.73,1.45,3.29.63a20,20,0,0,1,16.94-.9,21.39,21.39,0,0,1,13.25,25.83A22.18,22.18,0,0,1,144.57,47.82Z" />
        </G>
      </Svg>
